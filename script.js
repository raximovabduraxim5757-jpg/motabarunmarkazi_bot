...
var products = [
  ...
  /* =========================================================
     YANGI 7 TA
     RASMLAR SIZ YUBORGAN RASMDAN ALOHIDA
     ========================================================= */
...
function loadState() {
  ...
  try {
    ...
    cart = JSON.parse(
      localStorage.getItem("motabar_cart") || "{}"
    );
  ...
  try {
    ...
    favorites = JSON.parse(
      localStorage.getItem("motabar_favs") || "{}"
    );
...
function renderProducts() {
  ...
  filtered.forEach(function (p) {
    ...
    el.innerHTML =
      ...
      '<div class="product-card-top" onclick="openProductModal(\'' +
      p.id +
      '\')">' +
      ...
      '<div class="product-card-body">' +
        ...
        '<div class="card-actions">' +
          ...
          '<button class="btn btn-add" onclick="quickAdd(\'' +
          p.id +
          '\')">' +
...
function openProductModal(id) {
  ...
  document.getElementById(
    "sheet-adv"
  ).textContent = p.advantage;


  document.getElementById(
    "sheet-best"
  ).textContent = p.bestFor;


  document.getElementById(
    "sheet-qty"
  ).textContent = sheetQtyVal;


  var favBtn =
    document.getElementById("sheet-fav");
          ...
          row.innerHTML =
            ...
            '<div class="cart-item-controls">' +
              ...
              '<div class="qty-stepper">' +
                ...
                '<button type="button" onclick="setCartQty(\'' +
                id +
                "'," +
                (qty - 1) +
                ')">−</button>' +
  ...
  if (
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      function () {
        ...
        showToast(
          "Lokatsiyani olish uchun ruxsat bering yoki manzilni qo'lda yozing.",
          "error"
        );
...
function submitOrder(e) {
  ...
  message +=
    "YANGI ZAKAZ - Mo'tabar Un Markazi\n";
  ...
  var url =
    "https://t.me/unbaza_dostavka?text=" +
...
function openMap() {
  ...
  window.open(
    "https://www.google.com/maps?q=40.83012940337612,72.3528414804545",
    "_blank"
  );
...
document.addEventListener(
  ...
  function () {
    ...
    console.log(
      "Mo'tabar Un Markazi — 40 ta mahsulot bilan ishga tushdi!"
    );
